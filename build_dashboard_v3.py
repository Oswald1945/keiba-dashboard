...
<link rel="icon" type="image/png" href="data:image/png;base64,">
...
function renderBets(){
  ...
  // ── ③ 相手候補: 軸との偏差値差 ≤20、上限 min(6, 頭数//3)、断層カット(ギャップ5.0超で打切り) ──
  ...
  // 断層カット: 偏差値降順で連続ギャップが5.0超なら打ち切り（上限も併用）
  var _GAP=5.0, partners=[], _prev=null;
  for(var _pi=0;_pi<cand.length;_pi++){
    if(partners.length>=cap) break;
    var _pn=cand[_pi];
    if(partners.length>0 && (_prev-dv[_pn])>_GAP) break;
    partners.push(_pn); _prev=dv[_pn];
  }
  ...
  var _popsCt=contend.map(function(n){return _pop(n);});
  var _only123=_popsCt.every(function(p){return p===1||p===2||p===3;});   // フォーメーションが1-3番人気のみ
  var _all123in=[1,2,3].every(function(r){return _popsCt.indexOf(r)>=0;});// 1-3番人気を総取り
  var _c4=!(_only123||_all123in);
  ...
  if(anaMode){
    ...
    var opp3=_anaOpp3.slice().sort(_byUma);
